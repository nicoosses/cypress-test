...
describe('My first test suite', function () {
     ...
     it('3- Select one product', function () {
          ...
          cy.get('@varProducts').find('.product').eq(0).contains('ADD TO CART').click().then(function(){
               console.log('Este clg se ejecuta en el lugar correcto que indicamos en la cola de ordenes, porque realizamos la promise de manera manual con el then()')
          });
          console.log('este clg se ejecuta primero porque al ser un comando de javascript y cypress asincrono, ésta serála primer orden q se libera en la cola de órdenes')
